...
The preferred way to report is GitHub's private vulnerability reporting: on the affected repository, go to the **Security** tab and click **Report a vulnerability** (or open `https://github.com/getAlby/awesome-nwc/security/advisories/new`). Alternatively, you can email [security@getalby.com](mailto:security@getalby.com).
